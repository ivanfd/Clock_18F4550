...
ifeq "$(wildcard nbproject/Makefile-local-With_Loader.mk)" "nbproject/Makefile-local-With_Loader.mk"
include nbproject/Makefile-local-With_Loader.mk
endif
endif
...
ProjectName=MatrixClock4550
ConfName=With_Loader
ImagePath="dist\With_Loader\${IMAGE_TYPE}\4550.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\With_Loader\${IMAGE_TYPE}"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-With_Loader.mk ${DISTDIR}/4550.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${DISTDIR}/4550.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/4550.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_With_Loader=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=default,-0-FFF,-1006-1007,-1016-1017 -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x1000  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits  -Xparser -Wno-invalid-source-encoding -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/4550.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/4550.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/4550.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/4550.${IMAGE_TYPE}.map  -DXPRJ_With_Loader=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=default,-0-FFF,-1006-1007,-1016-1017 -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x1000  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits  -Xparser -Wno-invalid-source-encoding -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/4550.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     

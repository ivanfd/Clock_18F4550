...
grid via 0.0039
grid wire 0.0039
define (class Dip_Net_Class_0 AM_SDA DQ DS_CLK DS_CSN DS_DAT DS_INT HC-05_AT ISP_CLK_BUT_OK ISP_DAT_BUT_UP mclr NRF_CE NRF_CSN NRF_MISO NRF_MOSI NRF_SCK power_in RX_HC-05 SCL SDA TX_HC-05 USB_D+ USB_D- Vusb Сеть@4 Сеть@8 Сеть@9 Сеть@10 Сеть@12 Сеть@13 Сеть@20 Сеть@23 Сеть@24 Сеть@34 Сеть@35 Сеть@36 Сеть@37 Сеть@38 Сеть@39)

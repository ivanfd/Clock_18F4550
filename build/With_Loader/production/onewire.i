...
uint8_t ow_reset(void)
{
   ...
   presence = PORTDbits.RD6;
   _delay((unsigned long)((424)*(48000000/4000000.0)));
   return(presence);
}
...
uint8_t read_bit(void)
{
    ...
    PORTDbits.RD6 = 1;
    TRISDbits.RD6 = 1;
    _delay((unsigned long)((6)*(48000000/4000000.0)));
...
void write_bit(uint8_t bitval)
{
   ...
   _delay((unsigned long)((105)*(48000000/4000000.0)));
      PORTDbits.RD6 = 1;
      TRISDbits.RD6 = 1;
}
...
uint8_t read_byte(void)
{
   ...
   for(i=0;i<8;i++)
   {
      ...
      _delay((unsigned long)((120)*(48000000/4000000.0)));
   }

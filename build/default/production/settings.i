...
# 52 "C:/Users/User/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\pic\include\proc\pic18f4550.h"
...
# 19 "C:/Users/User/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\pic\include\pic18.h"
...
extern int8_t en_ds_1;
extern int8_t en_ds_2;
...
RTOS_SetTask(set_font_set, 0, 20);
RTOS_SetTask(default_state, 2000, 0);
events = 5;
en_put=1;
break;
...
RTOS_SetTask(set_type_clk, 0, 20);
RTOS_SetTask(default_state, 2000, 0);
events = 5;
en_put = 0;
clear_matrix();
...
RTOS_DeleteTask(brg_set);
RTOS_SetTask(set_brg_manual, 0, 20);
brig = read_eep(3);
Cmd7221(0x0A, brig);
RTOS_SetTask(default_state, 2000, 0);
events = 5;
...
RTOS_SetTask(set_type_temp, 0, 20);
RTOS_SetTask(default_state, 2000, 0);
events = 5;
en_put = 0;
clear_matrix();
...
RTOS_SetTask(set_en_am2302, 0, 20);
RTOS_SetTask(default_state, 2000, 0);
events = 5;
en_put = 0;
clear_matrix();
...
RTOS_SetTask(default_state, 2000, 0);
events = 5;
write_eep(10, (uint8_t)en_am2302);
break;
case 3:
en_am2302 = !(en_am2302);
RTOS_SetTask(default_state, 2000, 0);

...
void nrf24_init(uint8_t channel, uint8_t pay_length) {
    ...
    nrf24_write_reg(0x05, channel);

    nrf24_write_reg(0x11, 0x00);
    nrf24_write_reg(0x12, pay_length);
    nrf24_write_reg(0x13, 0x00);
    nrf24_write_reg(0x14, 0x00);
    nrf24_write_reg(0x15, 0x00);
    nrf24_write_reg(0x16, 0x00);


    nrf24_write_reg(0x06, (1 << 5) | (0 << 3) | ((0x03) << 1));


    nrf24_write_reg(0x00, ((1 << 3) | (0 << 2)));


    nrf24_write_reg(0x01, (1 << 0) | (1 << 1) | (0 << 2) | (0 << 3) | (0 << 4) | (0 << 5));
...
void nrf24_powerUpRx(void) {
    ...
    nrf24_write_reg(0x07, (1 << 6) | (1 << 5) | (1 << 4));

    LATCbits.LC1 = 0;
    nrf24_write_reg(0x00, ((1 << 3) | (0 << 2)) | ((1 << 1) | (1 << 0)));
    LATCbits.LC1 = 1;
    _delay((unsigned long)((135)*(48000000/4000000.0)));
}
# 95 "nrf24l01p.c"
void nrf24_write_reg(uint8_t reg, uint8_t value) {
    LATCbits.LC2 = 0;
    spi_rw((uint8_t) (0b00100000 | reg));
    spi_rw(value);
    LATCbits.LC2 = 1;
}
...
void nrf24_tx_address(const uint8_t *adr) {
    ...
    nrf24_write_buf(0b00100000 | 0x0A, adr, 5);
    nrf24_write_buf(0b00100000 | 0x10, adr, 5);
}


void nrf24_rx_address(const uint8_t *adr) {

    nrf24_write_buf(0b00100000 | 0x0B, adr, 5);
}
# 195 "nrf24l01p.c"
uint8_t nrf24_getStatus(void) {
    uint8_t r_status;
    LATCbits.LC2 = 0;
    r_status = spi_rw(0b11111111);
    LATCbits.LC2 = 1;
    return r_status;
}
# 242 "nrf24l01p.c"
void nrf24_getData(uint8_t* data) {
    ...
    nrf24_read_buf(0b01100001, data, pay_len);


    nrf24_write_reg(0x07, (1 << 6));
}
# 264 "nrf24l01p.c"
uint8_t nrf24_rxFifoEmpty(void) {
    uint8_t fifoStatus;

    fifoStatus = nrf24_read_reg(0x17);

    return (uint8_t) (fifoStatus & (1 << 0));
}
...
uint8_t nrf24_dataReady(void) {
    ...
    return (uint8_t) !nrf24_rxFifoEmpty();
    ;
}

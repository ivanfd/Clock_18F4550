...
void SYSTEM_Initialize(void)
{
    ...
    Port_Init();
    setting_Val[ENABLE_ESP] = read_eep(12);
    LATEbits.LE0 = setting_Val[ENABLE_ESP];
    ...
    bmp280_Init();
    si7021_init();
    setting_Val[TYPE_FONT] = read_eep(0);
    setting_Val[TYPE_CLK] = read_eep(1);
    if (setting_Val[TYPE_CLK] == 1)
        blk_dot = 0;
    else
        blk_dot = 1;
    setting_Val[TYPE_BRG] = read_eep(2);
    ...
    setting_Val[ENABLE_DS_1] = read_eep(5);
    setting_Val[ENABLE_DS_2] = read_eep(6);
    setting_Val[ENABLE_BMP] = read_eep(7);
    setting_Val[ENABLE_DST] = read_eep(8);
    setting_Val[TYPE_TEMP] = read_eep(9);
    TTime.TyrC = read_eep(13);
    setting_Val[ENABLE_DATE] = read_eep(14);

    setting_Val[ENABLE_DHT] = read_eep(10);

...
uint8_t idx_pnt = 0;
volatile uint8_t x1 = 0, x2 = 0, x3 = 0, x4 = 0, y1, y2, y3, y4;
uint16_t adc_res = 500;
uint8_t oldsec;
__bit oldsec_flag, mess_show;


uint8_t usart_data[150];
uint8_t blk_dot = 0;
...
uint8_t day_mess = 0;
uint8_t dst_flag = 0;
uint8_t const compile_date[12] = "May 28 2025";
uint8_t const compile_time[9] = "22:07:06";
uint8_t valuesAM[5];
uint8_t ErrAM;
...
void home_temp(void) {
    ...
    switch (events) {
        case 5:
            ...
            if ((setting_Val[TYPE_TEMP] == 1) || (data_Val[T_HOME] == 0)) {
                fptmp = data_Val[T_HOME] % 10;
                t_temp = data_Val[T_HOME] / 10;
                if (fptmp >= 6) t_temp += 1;
                ...
                if (text_buf[0] != 48) {
                    ...
                    putchar_down(11, text_buf[0] - 48, pFont);
                    putchar_down(17, text_buf[1] - 48, pFont);
                    putchar_down(23, text_buf[2], Font);

                    putchar_down(26, text_buf[3] - 48, pFont);
                    ...
                    putchar_down(11, text_buf[1] - 48, pFont);
                    putchar_down(17, text_buf[2], Font);
                    putchar_down(20, text_buf[3] - 48, pFont);
                    putchar_down(26, text_buf[4], Font);
            ...
            events = 6;
            RTOS_SetTask(default_state, 650, 0);
            break;
        case 6:
            break;
        case 4:
        ...
        case 5:
            ...
            if (err_ds18) {
                ...
                if (data_Val[T_RADIO] != 0xFFFF) {
                    ...
                    if ((setting_Val[TYPE_TEMP] == 1) || (data_Val[T_RADIO] == 0)) {
                        fptmp = data_Val[T_RADIO] % 10;
                        t_temp = data_Val[T_RADIO] / 10;
                        if (fptmp >= 6) t_temp += 1;
                        ...
                        if (text_buf[0] != 48) {
                            ...
                            putchar_down(17, text_buf[0] - 48, pFont);
                            putchar_down(23, text_buf[1] - 48, pFont);
                            putchar_down(29, text_buf[2], Font);

                            putchar_b_buf(32, text_buf[3] - 48, pFont, Dis_Buff);
...
void pressure(void) {
    ...
    switch (events) {
        case 5:
            ...
            events = 6;
            RTOS_SetTask(default_state, 400, 0);
...
# 745 "common.c"
                ...
                case 'b':
                    ...
                    if (((usart_data[2] - 48) == 0) || ((usart_data[2] - 48) == 1)) {
                        ...
                        write_eep(2, setting_Val[TYPE_BRG]);
                    } else {
                        usartEr();
                ...
                case 'a':
                    ...
                    if ((((usart_data[2] - 48) == 0) || ((usart_data[2] - 48) == 1)) && (((usart_data[3] - 48) == 0) || ((usart_data[3] - 48) == 1))) {
                        ...
                        write_eep(5, setting_Val[ENABLE_DS_1]);
                        write_eep(6, setting_Val[ENABLE_DS_2]);
                    } else {
                        usartEr();
                ...
                case 'e':
                    ...
                    if (((usart_data[2] - 48) == 0) || ((usart_data[2] - 48) == 1)) {
                        ...
                        write_eep(7, setting_Val[ENABLE_BMP]);
                    } else {
                        usartEr();
                ...
                case 'w':
                    ...
                    if (((usart_data[2] - 48) == 0) || ((usart_data[2] - 48) == 1)) {
                        ...
                        write_eep(8, setting_Val[ENABLE_DST]);
                    } else {
                        usartEr();
                ...
                case 'y':
                    ...
                    if (((usart_data[2] - 48) == 1) || ((usart_data[2] - 48) == 0)) {
                        ...
                        write_eep(10, setting_Val[ENABLE_DHT]);
                    } else {
                        usartEr();
...
# 1104 "common.c"
                        case 'v':
                            ...
                            for (j = 0; j < strlen("1.0.36"); j++)
                                EUSART_Write("1.0.36"[j]);
                            EUSART_Write(')');
                            EUSART_Write(' ');
                            EUSART_Write(' ');

                            for (j = 0; j < strlen("28.05.2025"); j++)
                                EUSART_Write("28.05.2025"[j]);
                            EUSART_Write(' ');

                            for (j = 0; j < strlen("22:07:03"); j++)
                                EUSART_Write("22:07:03"[j]);
                            EUSART_Write('\r');
                            EUSART_Write('\n');
                            break;
# 1148 "common.c"
...
void version(void) {
    ...
    strcpy((char *) text_buf, (const char *) "Clock v3.0.1 by Ivan_fd ");

...
uint16_t si7021_Hum(void) {
    ...
    I2C_Read(i2cBuffer, 0x80, 3, 0);
    tmp1 = (uint16_t)(i2cBuffer[0] << 8) | i2cBuffer[1];
    if (tmp1 == 65535)
        return 65535;
    tmp2 = (uint32_t) tmp1 * 12500;
    tmp2 = tmp2 / 65536;
    tmp2 = tmp2 - 600;
    tmpHi = (uint8_t)(tmp2 / 100);
    tmpLo = tmp2 % 100;

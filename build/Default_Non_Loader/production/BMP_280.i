...
void bmp280_Init(void) {
    ...
    dig_P1 = bmp280ReadInt16(0x8E);
    dig_P2 = (int16_t) bmp280ReadInt16(0x90);
    dig_P3 = (int16_t) bmp280ReadInt16(0x92);
    dig_P4 = (int16_t) bmp280ReadInt16(0x94);
    dig_P5 = (int16_t) bmp280ReadInt16(0x96);
    dig_P6 = (int16_t) bmp280ReadInt16(0x98);
    dig_P7 = (int16_t) bmp280ReadInt16(0x9A);
    dig_P8 = (int16_t) bmp280ReadInt16(0x9C);
    dig_P9 = (int16_t) bmp280ReadInt16(0x9E);


    i2cBuffer[0] = 0xF5;
    i2cBuffer[1] = 0xC0 | 0x0C | 0x00;
    I2C_Write(i2cBuffer, 0xEC, 2);

    i2cBuffer[0] = 0xF4;
    i2cBuffer[1] = 0xA0 | 0x14 | 0x03;
    I2C_Write(i2cBuffer, 0xEC, 2);
# 80 "BMP_280.c"
}
...
int32_t bmp280ReadTemp() {
    ...
    temperature = (int32_t) bmp280ReadInt32(0xFA);
...
int32_t bmp280ReadPressure(void) {
    ...
    pressure = (int32_t) bmp280ReadInt32(0xF7);
